            ...
            <div className="space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-6">
                  <div className="flex items-center flex-1">
                    ...
                    <div>
                      ...
                      <a 
                        href="mailto:fabiole.pt@gmail.com" 
                  ...
                  <div className="flex items-center flex-1">
                    <div className="w-12 h-12 bg-gradient-to-r from-[#FF6B35] to-orange-600 rounded-full flex items-center justify-center mr-4 shadow-lg">
                      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h2.28a2 2 0 011.94 1.52l.3 1.2a2 2 0 01-.45 1.95l-.7.7a16.06 16.06 0 006.36 6.36l.7-.7a2 2 0 011.95-.45l1.2.3A2 2 0 0121 18.72V21a2 2 0 01-2 2h-1C7.82 23 1 16.18 1 8V7a2 2 0 012-2z" />
                      </svg>
                    </div>
                    <div>
              ...
              <div className="bg-white rounded-2xl p-8 border border-blue-200 shadow-lg">
                ...
                <div className="flex gap-4">
                  <a
                    href="https://www.instagram.com/pt_fabiole"
                    target="_blank"
                  ...
                  <a
                    href="https://www.facebook.com/fabiole13"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-gradient-to-r from-blue-600 to-blue-400 rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform duration-300 shadow-lg"
                    aria-label="Facebook"
                  >
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a
                    href="https://www.linkedin.com/in/fabio-le"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-gradient-to-r from-blue-700 to-blue-500 rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform duration-300 shadow-lg"
                    aria-label="LinkedIn"
                  >
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a
                    href="https://www.youtube.com/channel/UCaVEJUlceBfmF-6GxKYeqhQ"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-gradient-to-r from-red-600 to-red-400 rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform duration-300 shadow-lg"
                    aria-label="YouTube"
                  >
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a
                    href="https://chat.whatsapp.com/Bzf2RZ500Ef2lOEcuu6m2S"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-gradient-to-r from-green-500 to-green-400 rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform duration-300 shadow-lg"
                    aria-label="WhatsApp"
                  >
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-white rounded-2xl p-8 border border-blue-200 shadow-lg">
                ...
                <div className="space-y-4 text-gray-800 text-base">
                  <div>
                    <span className="font-semibold">S. Félix da Marinha:</span> Estrada de Brito, 851 | 4410-206
                  </div>
                  <div>
                    <span className="font-semibold">Vila Nova de Gaia:</span> Rua Arcos do Sardão, 22 | 4430-272
                  </div>
                </div>
              </div>
            </div>
